    ...
    <AbsoluteFill style={{ backgroundColor: v2Colors.navy, alignItems: "center", justifyContent: "center" }}>
      <div style={{ maxWidth: 1400, textAlign: "center", marginBottom: 50 }}>
        <TypedText
          ...
          startFrame={0}
          perWord={8}
          style={{ fontSize: 50, fontWeight: 700, color: "#FFFFFF", lineHeight: 1.4 }}
        />
        <br />
        <TypedText
          ...
          startFrame={50}
          perWord={8}
          style={{ fontSize: 50, fontWeight: 700, color: "rgba(255,255,255,0.75)", lineHeight: 1.4 }}
        />
      </div>
      ...
      <PopIn startFrame={120} config={{ damping: 14 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          ...
          <div style={{ fontSize: 64, fontWeight: 800, color: "#FFFFFF" }}>VaaS</div>
        </div>
      </PopIn>

      <PopIn startFrame={150}>
        <div style={{ fontSize: 30, color: v2Colors.blue, marginTop: 26, fontWeight: 600 }}>
